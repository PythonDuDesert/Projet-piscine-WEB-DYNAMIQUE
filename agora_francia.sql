...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 27 mai 2025 à 09:18
...
(11, 'Erikson', 'Leif', '0970-08-13', 'leif.erikson@gmail.com', '0722345487', 36110, '1 Rue de l\'expedition', 'Lexplorateur', 'Islande12', 'images/leif.jpg', '1002-04-27', 3254, 2, '4322 3245 4356 1254'),
(12, 'Lucius Artorius Castus ', 'Askeladd', '0969-10-30', 'askeladd@agorafrancia.fr', '4567984190', 9988, '4 Rue du Jutland du Nord', 'Askeladd', 'Pirate3', 'images/askeladd.png', '1001-07-21', 12000, 3, '9171 9452 6821 1780 '),
(13, 'Jarl', 'Ulf', '0976-03-05', 'ulf.leouf@gmail.com', '4587432192', 9990, '343 Rue du Vinland', 'LeNavigateur', 'ulfff', 'images/ulf.png', '1021-09-19', 8467, 1, '6305 1571 8000 5331'),
(14, 'Knut', 'Knutsson', '0985-12-01', 'knut.legrand@agorafrancia.fr', '0612566360 ', 29000, '45 Avenue du Jelling ', 'KnutLeGrand', 'TheGreat', 'images/knut.jpg', '1017-09-23', 6000, 2, '5279 9917 4335 2424');
...
(14, 'Le Trône d\'Hadès', 'premium', '0336-06-06', 14, 9, 14, '2025-06-03 21:55:53', '\"Le véritable trône du Dieu des Enfers, récupéré après négociation avec Perséphone.\r\n\r\nMatière : Obsidienne pure incrustée d\'os de Titans\r\n\r\nDimensions : 2,5m de haut x 1,8m de large (poids : 888 kg)\r\n\r\nFonctionnalités :\r\n\r\nSiège chauffant à lave (réglabl', 1, 0, 'images/articles/Trone.jpeg', 4),
(15, 'Agenda Runique', 'Rare', '1002-07-28', 100, 80, 75, '2025-06-01 08:20:27', 'Organiseur en cuir gravé de runes. Livré avec un caillou pour graver les tâches.', 4, 1, 'images/articles/agendarunique.jpg', 12),
(16, 'Bouclier mural', 'Commun', '1021-09-21', 80, 68, 65, '2025-05-27 08:27:51', 'Bouclier mural décoratif datant des véritables Vikings. \r\nParfait en cas de manifestation.', 10, 3, 'images/articles/boucliermural.jpg', 13),
(17, 'Carte marine du Vinland', 'Commun', '1002-08-23', 30, 27, 25, '2025-05-31 08:31:53', 'Reproduction (plus ou moins fidèle) d’une carte utilisée pour atteindre les terres inconnues de l’ouest. Légende incluse : \"Attention aux serpents de mer\".', 15, 6, 'images/articles/cartemarine.jpg', 11),
(18, 'Casque Viking', 'Commun', '1018-01-03', 20, 18, 16, '2025-06-14 08:34:25', 'Casque Viking à cornes. Parfait en temps de guerre ou pour l\'anniversaire de Titouan.', 30, 5, 'images/articles/casque-viking.jpg', 14),
(19, 'Deguisement Viking', 'premium', '1002-05-01', 340, 290, 200, '2025-02-20 08:37:17', 'Deguisement de viking originel. D\'après la légende, le roi Sven l\'aurait porté.', 1, 0, 'images/articles/deguisementviking.jpg', 11),
(20, 'Drakkar Miniature', 'Rare', '1021-10-07', 90, 85, 80, '2025-05-07 08:40:01', 'Representation fidele et miniature du bateau des vikings.\r\nDimension 37.7cm x 12.1cm', 14, 2, 'images/articles/drakkar.jpg', 13),
(21, 'Drakkar Geant', 'premium', '1017-11-30', 2500, 2250, 2200, '2025-05-27 08:42:36', 'Véritable drakkar de l\'époque des vikings restauré à neuf.\r\nParfait pour partir en vacances en famille ou bien aller faire la guerre.\r\nDimension : 30m x 13m  ', 1, 0, 'images/articles/drakkarGeant.jpg', 14),
(22, 'Duo déguisement vikings', 'Commun', '1001-12-05', 70, 64, 60, '2025-06-24 08:45:12', 'Duo de déguisement vikings (1 homme, 1 femme)\r\nD\'après la légende vous seriez ridicule peu importe votre charisme en portant ces déguisements.\r\nLes haches, le bouclier, les casques sont bien entendu pas livrés avec le déguisement.', 4, 1, 'images/articles/duo-deguisement-viking.jpg', 12),
(23, 'Epée d\'Askeladd', 'premium', '1010-10-13', 400, 350, 330, '2025-05-27 08:50:05', 'Forgée dans les forges brumeuses des côtes galloises et trempée dans les mensonges d’un roi.\r\nCette arme aurait été utilisée dans plus de 36 duels malheureusement aucun témoin n\'a survécu.', 1, 0, 'images/articles/epee.askeladd.jpg', 12),
(24, 'Haches miniatures de décoration', 'Commun', '1002-07-12', 53, 46, 40, '2025-06-10 08:54:25', 'Petites haches en bois gravées, à accrocher dans la maison ou à offrir pour prouver son courage.', 12, 3, 'images/articles/hachesmini.jpg', 11),
(25, 'Les 10 grands secrets d\'un manipulateur', 'Commun', '1003-03-02', 24, 22, 17, '2025-06-02 08:57:10', 'Dans ce livre, Askeladd retrace les 10 plus grands secrets qui lui ont permis de conquérir le monde.\r\nEdition - Hachette ', 21, 8, 'images/articles/livre.askeladd.jpg', 11),
(26, 'Parfum \"Essence de conquête\"', 'Rare', '1021-07-17', 180, 150, 120, '2025-05-31 09:01:07', 'Une mixture à base de pin nordique, de sueur de berserker et d’ambre. \"Pour imposer le respect sans lever la hache\"', 6, 1, 'images/articles/parfum.jpg', 13);
